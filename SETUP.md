...
It installs required Python packages and syncs SEO Helper skills into common local skill folders and registers the plugin picker entry and `/seo-helper` command for this Windows user:

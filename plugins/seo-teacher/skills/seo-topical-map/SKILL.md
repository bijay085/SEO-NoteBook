...
- **Geography** — local SEO triggers the location–service adjustment (Koray #4).
...
primary_bucket, secondary_bucket`. **Salience** 0–1 vs the central entity (central = 1.0).
**Relevance layers:** Core / Primary (~0.75+) / Secondary (~0.45–0.75) / Outer (<0.45).
...
(2–3/4) with the **SERP 60% arbiter** (`mcp__dataforseo__serp_organic_live_advanced`):
...
4. **Location–service pairs** (local only) — canonical service page at root; city pages

...
"insufficient permission." GSC lags ~2–3 days, so end the window ~2 days before today. Copy
...
site. `max_urls` defaults to **400** (top by impressions). The app took 45–75 min on ~3,800 pages

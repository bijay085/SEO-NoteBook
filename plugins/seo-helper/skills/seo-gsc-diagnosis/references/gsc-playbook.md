...
- GSC data lags ~2 to 3 days. Set `endDate` to ~2 days before today.
- Default to a 3 to 6 month window for a stable picture. Narrow it to spot recent changes
...
| 11 to 20 | ≳ 1% | page-2 quick win | on-page + internal links to push to page 1 |

A page averaging position ~5 with 0.1 to 0.5% CTR across hundreds of thousands of impressions is the

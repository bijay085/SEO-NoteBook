...
| 8 | **Action Items** — prioritized P0–P2, executable, revenue-weighted | all of the above | author |

Scale to inputs: no outbound links found → 1–2 drop or go light; no review content →
4–6 drop; no GSC → revenue-weighting falls back to traffic estimate and says so. Always

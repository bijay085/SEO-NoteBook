...
Render audit: compare raw HTML vs rendered DOM, find JS-hidden content, crawl-unfriendly patterns, Googlebot render gaps. Uses Playwright or a supplied rendered DOM.

...
## DONE
- **rules.csv — 73 active rules** (80 merged − 7 deduped), 14-col unified schema,
...
- `scripts/build_report.py` — A–F report via reused `report_kit.py` + `charts.py`.
- `scripts/build_wireframe.py` — required annotated SVG wireframe (Miro-or-equivalent).
- All three self-tested on fixtures (report: 6 A–F blocks + accordions + chart;

...
solution, execution}** (see `methodology.md` §9 to 10). `evidence` is measured or verbatim;
...
- Is the site's score (Fuel Score / stars / 1 to 10) applied **only** to genuine reviews?
...
- Consolidate every finding into a prioritized list, **weighted by revenue/traffic ×
  ...
  · Priority (P0 week / P1 30d / P2 60 to 90d). If a **task log** was supplied, tag each

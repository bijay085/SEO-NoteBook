...
usually has 2 to 3 of these at once.
...
| **3. Zero-click SERP interception** | Non-brand terms rank page-1 but CTR is ~0% on big impressions (AI Overviews / PAA / featured snippet answer on the SERP) | SERP-feature capture (40 to 55-word answer blocks, FAQ schema) + pivot effort to click-earning intents. **NOT "rank higher" : you already rank.** |
| **4. Wrong-intent content** | A large informational bank earns impressions but never converts; the **commercial/money** terms sit page 3 to 5 | Build/strengthen commercial (collection/service/location) pages; wire blog→collection→product funnels |
...
3. **Non-brand position bands** : share of non-brand impressions in pos 1 to 3 / 4 to 10 / 11 to 20 / 21+.
...
5. **Graduation Score** (0 to 100) : a documented composite, below.

**Data-integrity rules (do not skip):** date-dim totals only for the trend; query-dim undercounts;
exclude partial months from every chart/table; GSC lags ~2 to 3 days.

## The Graduation Score (0 to 100) : a heuristic, stated as one

Composite of four clamped 0 to 1 components (weights in parentheses):
...
- **CTR-at-rank health** = median CTR of non-brand pos-4 to 10 queries vs 3% (0.15)

Bands: **≥70** graduated/graduating · **45 to 69** emerging · **25 to 44** suppressed (classic

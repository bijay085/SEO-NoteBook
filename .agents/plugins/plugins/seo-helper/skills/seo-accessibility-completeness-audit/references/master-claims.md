...
| 18 | "[Rank anything first]" framework increased rankings 20 to 60% | D | No percentage appears anywhere in the paper; it's an adversarial-attack disclosure the authors warn against, not a ranking-boost technique | [02](02-papers-verification.md)§3 |
...
| 34 | "Every 10 to 20 pixels" introduces an interaction point | D | Unfalsifiable rhetoric : no defined device, viewport, sample, or test anywhere | [10](10-critical-reading-and-methodology.md) |
